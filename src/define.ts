 ...
 */
export const defineApplier = <V extends JebVM, const T extends Type[], PO extends ProtocolObj<V, void, [T], {}, ApplyMetadata, ApplyFlags>>(vm: V, type: T, run: PO["run"], describe: PO["describe"], doc: string) => {
...
export const defineEvaluator = <V extends JebVM, const T extends Type[]>(vm: JebVM, type: T, fn: ProtocolObj<V, void, [T], {}, void, EvalFlags>["run"], doc: string) => {
...
export const defineAccessor = <V extends JebVM, const T extends Type[]>(vm: JebVM, type: T, fn: ProtocolObj<V, Reference, [T], {}, void, AccessFlags>["run"], doc: string) => {
...
export const defineUnwrapper = <V extends JebVM, const T extends (typeof Wrapper)[]>(vm: JebVM, type: T, fn: ProtocolObj<V, void, [T], {}, void, void>["run"], doc: string) => {
